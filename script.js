document.addEventListener('DOMContentLoaded', () => {
    const translations = {
        'es': {
            ...
            'project-4-title': 'Calendario Hebreo',
            'project-4-desc': 'Aplicación móvil que permite visualizar el calendario judío, así como las fiestas y horarios relevantes.',
            'project-5-title': 'Conversión de Moneda',
            'project-5-desc': 'Aplicación móvil para convertir monedas en tiempo real, con una interfaz limpia e intuitiva.',
            'project-6-title': 'Kosher Pass',
            'project-6-desc': 'Aplicación móvil para consultar productos Kosher alrededor del mundo, con búsqueda por certificación, categoría y país.',
            'project-6-status': '<i class="fa-solid fa-clock"></i> En desarrollo',
        ...
        'en': {
            ...
            'project-6-title': 'Kosher Pass',
            'project-6-desc': 'Mobile application to browse Kosher products around the world, with search by certification, category and country.',
            'project-6-status': '<i class="fa-solid fa-clock"></i> In development',
